...
class VaultDB extends Dexie {
  ...
  constructor() {
    ...
    this.version(2).stores({
      ...
      documents:
        'id, person_id, category_id, type, title, is_favorite, synced, created_at',
      syncQueue:
        'id, table, operation, created_at, user_id, retry_count, failed',
    });
    ...
    this.version(4).stores({
      persons: 'id, user_id, name, synced, created_at',
      documents:
        'id, person_id, category_id, type, title, is_favorite, synced, created_at, vault_id',
      syncQueue:
        'id, table, operation, created_at, user_id, retry_count, failed',
      medicamentos: 'id, document_id, nome, medico, proxima_renovacao',
      renovacoes: 'id, medicamento_id, data',
    ...
    this.version(6).stores({
      persons: 'id, user_id, name, synced, created_at',
      documents:
        'id, user_id, person_id, category_id, type, title, is_favorite, synced, created_at, vault_id',
      syncQueue:
        'id, table, operation, created_at, user_id, retry_count, failed',
      medicamentos: 'id, document_id, nome, medico, proxima_renovacao',
      renovacoes: 'id, medicamento_id, data',
    ...
    this.version(8).stores({
      ...
      syncQueue:
        'id, table, operation, created_at, user_id, retry_count, failed',
      medicamentos:
        'id, user_id, document_id, nome, medico, proxima_renovacao',
    ...
    this.version(12).stores({
      ...
      syncQueue:
        'id, table, operation, created_at, user_id, retry_count, failed',
      medicamentos:
        'id, user_id, document_id, nome, medico, proxima_renovacao, tratamento_id',
      renovacoes: 'id, user_id, medicamento_id, data',
      vaults: 'id, user_id, name, synced, created_at',
      vaultMembers: 'id, vault_id, user_id, email, status, synced',
      medicos: 'id, user_id, nome, especialidade, synced',
    ...
    this.version(13).stores({
      ...
      syncQueue:
        'id, table, operation, created_at, user_id, retry_count, failed',
      medicamentos:
        'id, user_id, document_id, nome, medico, proxima_renovacao, tratamento_id, status',
      renovacoes: 'id, user_id, medicamento_id, data',
      vaults: 'id, user_id, name, synced, created_at',
      vaultMembers: 'id, vault_id, user_id, email, status, synced',
      medicos: 'id, user_id, nome, especialidade, synced',
    ...
    this.version(15).stores({
      ...
      anexos_clinicos:
        'id, user_id, person_id, tratamento_id, medicamento_id, tipo, *tags, created_at',
    });
    ...
    this.version(16).stores({
      ...
      syncQueue:
        'id, table, operation, created_at, user_id, retry_count, failed',
      medicamentos:
        'id, user_id, person_id, document_id, nome, medico_id, farmacia_id, proxima_renovacao, status, tratamento_id',
      renovacoes: 'id, user_id, medicamento_id, data',
      vaults: 'id, user_id, name, synced, created_at',
      vaultMembers: 'id, vault_id, user_id, email, status, synced',
      medicos: 'id, user_id, nome, especialidade, synced',
      ...
      laboratorios: 'id, user_id, nome, synced',
      exames:
        'id, user_id, person_id, nome, laboratorio_id, medico_id, data, synced',
      doseLogs: 'id, user_id, medicamento_id, data, horario',
      credentials: 'id, user_id, vault_id, title, category, synced',
      cards: 'id, user_id, title, bank_name, type, brand, synced',
      instituicoes: 'id, user_id, nome, synced',
      tratamentos:
        'id, user_id, person_id, nome, cid_id, status, synced',
      medicamento_tratamentos: 'id, medicamento_id, tratamento_id',
      anexos_clinicos:
        'id, user_id, person_id, tratamento_id, medicamento_id, tipo, *tags, created_at',
    ...
    this.version(17).stores({
      ...
      exames:
        'id, user_id, person_id, nome, laboratorio_id, medico_id, data, synced',
      consultas:
        'id, user_id, person_id, data, medico_id, hospital_id, status, synced',
      cirurgias:
        'id, user_id, person_id, data, medico_id, hospital_id, status, synced',
      doseLogs: 'id, user_id, medicamento_id, data, horario',
      credentials: 'id, user_id, vault_id, title, category, synced',
...
export async function syncMedicamentoTratamentos(
  ...
  await db.transaction(
    ...
    db.syncQueue,
    async () => {
      const antigos = await db.medicamento_tratamentos
        .where('medicamento_id')
        .equals(medicamentoId)
        .toArray();

      for (const vinculo of antigos) {
      ...
      const novosVinculos = tratamentoIds.map((tratamentoId) => ({
        id: generateId(),
      ...
      if (novosVinculos.length > 0) {
        ...
        for (const vinculo of novosVinculos) {
          await db.syncQueue.add({
            id: generateId(),
            table: 'medicamento_tratamentos',
            operation: 'add',
...
export async function safeUpdateLocal(
  ...
  await db.transaction('rw', db.locais, db.syncQueue, async () => {
    ...
    if (!existing) {
      throw new Error('Local de saúde não encontrado');
    }
...
export async function safeDeleteExame(id: string): Promise<void> {
  ...
  await db.transaction(
    ...
    async () => {
      ...
      const vinculos = await db.exame_tratamentos
        .where('exame_id')
        .equals(id)
        .toArray();

      for (const vinculo of vinculos) {
        await db.exame_tratamentos.delete(vinculo.id);
...
export async function safeAddLaboratorio(
  data: Omit<
    Laboratorio,
    'id' | 'created_at' | 'updated_at' | 'synced'
  >,
...
export async function safeUpdateLaboratorio(
  id: string,
  changes: Partial<Laboratorio>,
): Promise<void> {
  const timestamp = nowIso();
  ...
  await db.transaction(
    ...
    async () => {
      ...
      await db.laboratorios.update(id, {
        ...changes,
        updated_at: timestamp,
        synced: false,
      });
...
export async function safeAddAnexoClinico(
  data: Omit<any, 'id' | 'created_at' | 'updated_at' | 'synced'>,
): Promise<string> {
  const timestamp = nowIso();
  const id = generateId();
