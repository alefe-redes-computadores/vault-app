    ...
    <section className="space-y-5" aria-label="Central do Vault">
      ...
      <div>
        ...
        <div className="overflow-hidden rounded-[24px] border border-surface-border/60 bg-surface">
          <button type="button" onClick={() => go("/documentos")} className="flex w-full items-center gap-3 border-b border-surface-border/50 p-4 text-left"><FileText size={18} className="text-ice" /><div className="min-w-0 flex-1"><p className="text-sm font-semibold">Meus arquivos</p><p className="text-[10px] text-ink-muted">Documentos pessoais e acervo clínico</p></div><ChevronRight size={16} className="text-ink-faint" /></button>
