...
import { ArrowLeft, Save, Loader2, Store, MapPin, Phone } from "lucide-react";
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0">
              ...
              <p className="mt-1 text-sm text-ink-muted">
                Cadastre uma farmácia para usar em receitas e registros
              </p>
            </div>
          </div>
        </header>
          ...
          >
            <div className="mb-6 flex items-center gap-4">
              <div className="flex h-16 w-16 items-center justify-center rounded-[20px] border border-surface-border/50 bg-surface-raised shadow-sm">
                <Store size={28} className="text-ice" />
              </div>
              ...
              <div className="min-w-0">
                ...
                <p className="mt-1 text-xs leading-5 text-ink-faint">
                  Salve os dados principais para agilizar o preenchimento em fluxos de saúde.
                </p>
              </div>
            </div>
