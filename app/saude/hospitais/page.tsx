...
export default function HospitaisPage() {
  ...
  }, [hospitaisFiltradosPorPessoa, cirurgias, consultas, exames, medicos]);
        ...
        <section className="px-5 pt-5 space-y-3.5">
          {filteredHospitais.length === 0 ? (
            <EmptyState
              ...
              title={
                activePersonId
                  ? "Nenhum hospital vinculado a esta pessoa"
              ...
              description={
                search || filtroTipo !== "todos"
                  ...
                  : activePersonId
                  ? "Cadastre consultas, cirurgias ou exames para vincular hospitais."
