...
import type { Medico, Consulta, Cirurgia, Medicamento } from "@/lib/types";
        ...
        <section className="px-5 pt-6 space-y-5">
          ...
          <motion.div variants={fadeUp} initial="initial" animate="animate" transition={{ delay: 0.05 }} className="space-y-4 pt-2">
            ...
            <div className="grid grid-cols-1 gap-3">
              ...
              {/* Vínculo de Cirurgias */}
              <div className="rounded-[24px] border border-surface-border/50 bg-surface p-4 shadow-sm space-y-3">
                <div className="flex items-center gap-2">
                  <Activity size={16} className="text-coral" />
                  <h4 className="text-sm font-semibold text-ink-primary">Procedimentos Cirúrgicos ({cirurgias.length})</h4>
                </div>
                {cirurgias.length === 0 ? (
