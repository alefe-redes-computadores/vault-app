      ...
      try {
        await run(
          async () => {
            ...
            /*
             * Toda a criação passa pelo hook person-scoped.
             *
             * medicamento_ids é comando de domínio:
             * o repository converte essa seleção para a fonte
            ...
            <div>
              ...
              {status !==
                ...
                <p className="mt-2 text-[11px] leading-relaxed text-ink-muted">
                  Medicamentos vinculados só serão descontinuados automaticamente se não estiverem associados a outro tratamento ativo da mesma pessoa.
                </p>
              )}
            </div>
