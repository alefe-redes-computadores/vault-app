    ...
    const load =
      async () => {
        ...
        try {
          ...
          /*
           * Vínculos antigos que pertençam a outra pessoa
           * não entram no formulário e não voltam no update.
           */
          setTratamentosSelecionados(
            sanitizeSelectedIds(
              data.tratamento_ids,
              tratamentoIdsPermitidos
            )
          );
          ...
          if (
            ...
            showToast(
              "Não foi possível carregar a cirurgia.",
              "error"
            );
  ...
  const validate =
    (): boolean => {
      ...
      if (
        ...
        newErrors.person_id =
          "A cirurgia não pertence à pessoa ativa";
      }
  ...
  const handleSubmit =
    () => {
      ...
      if (
        ...
        showToast(
          "Não foi possível validar a cirurgia para a pessoa ativa.",
          "error"
        );
      ...
      run(
        async () => {
          try {
            ...
            /*
             * Sanitização final antes do update.
             * Mesmo que o estado tenha sido alterado fora do
             * fluxo normal, só IDs da pessoa ativa persistem.
             */
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              onClick={() => {
                ...
                router.replace(
                  `/saude/cirurgias/detalhes?id=${id}`
                );
              }}
